...
const (
	...
	azureCloudControllerManagerImageReference         string = "oss/kubernetes/azure-cloud-controller-manager:v1.0.0"
	azureCloudNodeManagerImageReference               string = "oss/kubernetes/azure-cloud-node-manager:v1.0.0"
